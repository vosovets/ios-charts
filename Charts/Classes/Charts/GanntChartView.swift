...
public class GantChartView: BarChartView
{
    
    /// the object representing the labels on the x-axis
//    internal var _topHeaderAxis: ChartXAxis!
//    internal var _topHeaderAxisRenderer: ChartXAxisRenderer!
//    
//    internal var _topHeaderAxisTransformer: ChartTransformer!
...
//        _topHeaderAxisTransformer = ChartTransformerHorizontalBarChart(viewPortHandler: _viewPortHandler)
        
        let ganntRenderer = GanttChartRenderer(dataProvider: self, animator: _animator, viewPortHandler: _viewPortHandler)
        
        ganntRenderer.valueLabelAnchorCenter = true
        
        renderer = ganntRenderer
...
//        _topHeaderAxisRenderer = ChartTopHeaderAxisRendererHorizontalBarChart(viewPortHandler: _viewPortHandler, xAxis: _topHeaderAxis, transformer: _topHeaderAxisTransformer, chart: self)
    ...
    public func setGanttData(durationData: [String: String] ) -> Void {
